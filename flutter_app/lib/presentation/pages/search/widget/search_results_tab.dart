...
class SearchResultsTab extends ConsumerStatefulWidget {
  const SearchResultsTab({Key? key}) : super(key: key);

  @override
  ConsumerState<SearchResultsTab> createState() => _SearchResultsTabState();
}

class _SearchResultsTabState extends ConsumerState<SearchResultsTab> {
  @override
  Widget build(BuildContext context) {
    ...
    switch (status) {
      ...
      case SearchStatus.loading:
        // Check if results are empty without rebuilding when results change
        ...
        return _buildSearchGrid(context, ref);
  ...
  Widget _buildSearchGrid(BuildContext context, WidgetRef ref) {
    ...
    return RefreshIndicator(
      ...
      child: NotificationListener<ScrollNotification>(
        ...
        child: Column(
          children: [
            // Search results grid that only rebuilds when results list changes
            Expanded(
              child: Consumer(
                builder: (context, ref, _) {
                  ...
                  final comicItems = searchResults
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ElevatedButton(
            onPressed: () => notifier.searchManga(),
